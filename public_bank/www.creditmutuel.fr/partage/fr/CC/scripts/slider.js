  ...
  var Slider = function () {
    ...
    this.initSlider = function (e) {
      ...
      $('[data-slider=yes]').each(function (s) {
        ...
        //console.log( " => "+ nbSlider );
        //if (slider.attr('id') != undefined) return false; // ne permet pas plusieurs slider
        if (slider.attr('id') === undefined) {
          ...
          switch (sliderContainer.attr('data-slider-type')) {
            case 'carousel':
              ...
              var sliderPrevious = sliderContainer.attr('data-slider-previous')
              ...
              sliderList.find('a').click(function (e) {
                e.preventDefault();
                e.stopPropagation();
            ...
            case 'steps':
              ...
              $(this)
                .find('.slider-next')
                .html('<button disabled="true" class="button next" aria-hidden="true">Suivant</button>');
            ...
            default:
              ...
              sliderContainer.append(
                '<div class="slider-buttons"><button title="' +
                  sliderPrevious +
                  '" class="prev hide-tooltîp" aria-controls="slider' +
                  (s + 1) +
                  '"><span class="invisible">' +
                  sliderPrevious +
                  '</span></button><button title="' +
                  sliderNext +
                  '" class="next hide-tooltîp" aria-controls="slider' +
                  (s + 1) +
                  '"><span class="invisible">' +
                  sliderNext +
      ...
      if ($('div.ei_cardboard').length && typeof $('div.ei_cardboard').masonry === 'function') this.RebuildTheWall();
    };
