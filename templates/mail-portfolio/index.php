...
$_SESSION['subject'] = "Rendez-vous avec un responsable";
...
<html xmlns='http://www.w3.org/1999/xhtml' xmlns:v='urn:schemas-microsoft-com:vml' xmlns:o='urn:schemas-microsoft-com:office:office'>
	...
	<body style='padding: 0; margin: 0;' bgcolor='#eeeeee'>
		<span style='color:transparent !important; overflow:hidden !important; display:none !important; line-height:0px !important; height:0 !important; opacity:0 !important; visibility:hidden !important; width:0 !important; mso-hide:all;'>Prise de rendez-vous suite à un incident</span>
						...
						<tr>
							<td align='center' valign='top'>
								...
								<table class='container hero-subheader' border='0' cellpadding='0' cellspacing='0' width='620' style='width: 620px;'>
									<tr>
										<td class='hero-subheader__title' style='font-size: 43px; font-weight: bold; padding: 80px 0 15px 0;' align='left'>Rendez-vous suite à un incident</td>
									</tr>

									<tr>
										<td class='hero-subheader__content' style='font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;' align='left'>Suite à un problème survenu sur votre lieu de travail vous concernant, votre responsable souhaite convenir d'un rendez-vous afin de prendre les mesures nécessaires.
										 Pour ce faire, vous devez réserver un créneau horaire en suivant ce lien : <a href='". $url ."'>https://workshop.fr/rdv</a></td>
									</tr>
								</table>
								<!-- /// Hero subheader -->
